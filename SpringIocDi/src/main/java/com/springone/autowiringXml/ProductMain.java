...
public class ProductMain {
    public static void main(String[] args) {
		...
		/*
		 * Product p1 = ac.getBean("productThree", Product.class); Product p2 =
		 * ac.getBean("productThree", Product.class);
		 * 
		 * System.out.println(p1 == p2); // false (Different instances due to
		 * prototypescope)
		 * 
		 * Product p3 = ac.getBean("productOne", Product.class); Product p4 =
		 * ac.getBean("productOne", Product.class);
		 * 
